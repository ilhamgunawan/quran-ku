  ...
  return (
    <>
      ...
      <main style={{ width: '95%', marginLeft: 'auto', marginRight: 'auto' }} className='my-16 flex flex-col items-center'>
        <p style={{ maxWidth: '350px' }} className='py-10 text-center text-xl font-normal'><strong>Qur'anKu</strong> adalah aplikasi Al-Qur'an berbasis web yang dioptimalkan untuk digunakan pada perangkat mobile maupun desktop.</p>
        <section className='mx-8'>
          <h2>Sumber data yang digunakan Qur'anKu:</h2>
          <ul className='list-disc'>
            <li>
              <p><a href='https://github.com/rioastamal/quran-json' target='_blank' rel='noreferrer noopener' className='text-blue-400 font-semibold'>quran-json</a> sebagai sumber data Al-Qur'an dan terjemahan Bahasa Indonesia</p>
            </li>
            <li>
              <p><a href='https://github.com/penggguna/QuranJSON' target='_blank' rel='noreferrer noopener' className='text-blue-400 font-semibold'>QuranJson</a> sebagai sumber data mp3 murottal Al-Qur'an</p>
            </li>
            <li>
              <p><a href='https://quran.kemenag.go.id/' target='_blank' rel='noreferrer noopener' className='text-blue-400 font-semibold'>Quran Kemenag</a> sebagai sumber data tafsir Al-Qur'an</p>
            </li>
            <li>
