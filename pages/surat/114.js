...
import { getArabicNumber, mapAyatObjectToArray, getAyatNumberList } from '../../utils/utils';
...
const AnNaas = ({ newSurah }) => {
  ...
  const dispatchCurrentMurottal = async () => {
    ...
    dispatch(setCurrentMurottal('https://download.quranicaudio.com/quran/mishaari_raashid_al_3afaasee/114.mp3'));
  };
