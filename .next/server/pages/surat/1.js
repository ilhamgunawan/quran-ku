...
const getStaticProps = async ()=>{
    const surahDetails = await (0,_data_sources_data_sources__WEBPACK_IMPORTED_MODULE_3__/* .getSurah */ .Nz)("1");
    return {
        props: {
...
const AlFatihah = ({ newSurah  })=>{
    ...
    const { 0: surah , 1: setSurah  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({
        versesArray: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__/* .mapAyatObjectToArray */ .s4)(text, translations.id.text)
    });
    const { versesArray  } = surah;
    const setAyatList = ()=>{
        dispatch((0,_state_actions__WEBPACK_IMPORTED_MODULE_5__/* .setCurrentAyatNumberList */ .oC)((0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__/* .getAyatNumberList */ .bM)(versesArray)));
    };
    const dispatchCurrentMurottal = async ()=>{
        ...
        dispatch((0,_state_actions__WEBPACK_IMPORTED_MODULE_5__/* .setCurrentMurottal */ .$n)("https://download.quranicaudio.com/quran/mishaari_raashid_al_3afaasee/001.mp3"));
    };
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_1___default()), {
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("title", {
                        children: "Qur'an Surat Al-Fatihah | Qur'anKu"
                    }),
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("main", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("ul", {
                        children: versesArray.map((ayat)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ayat_list_ayat_list_item__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z, {
                                surahId: "1",
                                surahName: "Al-Fatihah",
                                ...ayat
                            }, `Al-Fatihah-${ayat.ayatNumber}`)
                        )
                    }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AlFatihah);
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,969,441,763,601,701,874], () => (__webpack_exec__(7883)));
