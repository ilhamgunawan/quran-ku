  ...
  return (
    <li className='mb-5 border-b pb-3'>
      ...
      <div className='flex flex-col'>
        <div className='grid'>
          <p className='arabic-text col-start-1 h-10 w-10 mt-auto mb-6 text-2xl leading-none bg-blue-200 text-gray-700 flex justify-center items-center rounded-full'>{getArabicNumber(ayatNumber)}</p>
