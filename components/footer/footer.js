    ...
    return (
      <footer className='w-full fixed bottom-0 inset-x-0 flex bg-gray-900'>
        <div className='w-full flex footer-buttons'>
          ...
          {
            isMurottalPlaying
              ? <button className='w-full flex flex-col items-center bg-gray-900 p-1 focus:outline-none' onClick={pauseMurottal}>
                  <span><PauseIcon /></span>
                  <span className='text-white font-light text-xs'>Pause Murottal</span>
                </button>
              : <button className='w-full flex flex-col items-center bg-gray-900 p-1 focus:outline-none' onClick={playMurottal}>
                  <span><PlayIcon /></span>
                  <span className='text-white font-light text-xs'>Play Murottal</span>
                </button>
          }
          <div style={{ position:'relative' }} className='w-full'>
            <button className='w-full flex flex-col items-center bg-gray-900 p-1 focus:outline-none' onClick={() => dispatch(setDaftarAyatToggle())}>
              <span><ListIcon /></span>
